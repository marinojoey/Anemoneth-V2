...
def seed_users():
    owner = User(username='owner', address='0xae90d6C1360d095a03c4AAf378Bf20cEcdB27630', password='passwordae8')
    ...
    anakin = User(username='anakin', address='0x0bffe95D6fcb2998721E9907A42434CD4512eE4B', password='password0bf')
    bombadil = User(username='bombadil', address='0x8C2c1Fc67CaDbd4Fd5D45C3a6A013A80Ee4467D3', password='password8c8')
